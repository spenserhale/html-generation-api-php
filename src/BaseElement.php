...
use SpenserHale\Html\Exceptions\InvalidChild;
use SpenserHale\Html\Exceptions\InvalidHtml;
...
abstract class BaseElement implements Htmlable, HtmlElement
{
    ...
    /** @var \SpenserHale\Html\Attributes */
    ...
    /**
     * @param \SpenserHale\Html\HtmlElement|string|iterable|int|float|null $children
     ...
     *
     * @param \SpenserHale\Html\HtmlElement[] $children
     * @param callable|null $mapper
     *
     * @return static
     */
